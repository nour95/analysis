...
def plot_4_bars(labels, data_list, d_map):
    ...
    rects3 = ax.bar(x + 3*indent, bes_no_l[0], width, label=d_map['bes_no_l_label'], edgecolor='black', color='#004E90', hatch='x')

    # rects4 = ax.bar(x - 3*indent, rand_no_l[0], width, label=d_map['random_no_l_label'], edgecolor='black', color='white', hatch='//')
    # rects1 = ax.bar(x - indent, bes_l[0], width, label=d_map['bes_l_label'], edgecolor='black', color='#9FACCE', hatch='-')
    # rects2 = ax.bar(x + indent, rand_l[0], width, label=d_map['random_l_label'], edgecolor='black', color='#617CB3', hatch='.')
    
    # rects3 = ax.bar(x + 3*indent, bes_no_l[0], width, label=d_map['bes_no_l_label'], edgecolor='black', color='#004E90', hatch='x')
    # time4 = ax.bar(x - 3*indent, rand_no_l[1], width, label=f'{d_map["random_no_l_label"]}_timeout', edgecolor='black', color='white', hatch='+-')
    # time1 = ax.bar(x - indent, bes_l[1], width, label=f'{d_map["bes_l_label"]}_timeout', edgecolor='black', color='#9FACCE', hatch='\\-')
    # time2 = ax.bar(x + indent, rand_l[1], width, label=f'{d_map["random_l_label"]}_timeout', edgecolor='black', color='#617CB3', hatch='*-')
    
    # time3 = ax.bar(x + 3*indent, bes_no_l[1], width, label=f'{d_map["bes_no_l_label"]}_timeout',  edgecolor='black', color='#004E90', hatch='o-')

    #time outs:
    time4 = ax.bar(x - 3*indent, rand_no_l[1], width, label=f'{d_map["random_no_l_label"]}_timeout', edgecolor='black', color='white', hatch='//-')
    time1 = ax.bar(x - indent, bes_l[1], width, label=f'{d_map["bes_l_label"]}_timeout', edgecolor='black', color='#9FACCE', hatch='O-')
    time2 = ax.bar(x + indent, rand_l[1], width, label=f'{d_map["random_l_label"]}_timeout', edgecolor='black', color='#617CB3', hatch='.-')
    
    time3 = ax.bar(x + 3*indent, bes_no_l[1], width, label=f'{d_map["bes_no_l_label"]}_timeout',  edgecolor='black', color='#004E90', hatch='x-')
    ...
    # ax.legend()
    # ax.legend(fontsize="x-large") # using a named size
